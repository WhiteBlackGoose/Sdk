...
{
    using global::Elskom.Generic.Libs;
    using global::System;
    ...
    {
        /// <inheritdoc cref = "MiniDumpWriteDump(HANDLE, uint, HANDLE, MINIDUMP_TYPE, MINIDUMP_EXCEPTION_INFORMATION*, IntPtr, IntPtr)"/>
        internal static unsafe bool MiniDumpWriteDump(SafeHandle hProcess, uint processId, SafeHandle hFile, MINIDUMP_TYPE dumpType, MINIDUMP_EXCEPTION_INFORMATION? exceptionParam, IntPtr userStreamParam, IntPtr callbackParam)
        {
            ...
            try
            {
                ...
                return MiniDumpWriteDump(hProcessLocal, processId, hFileLocal, dumpType, exceptionParam.HasValue ? &exceptionParamLocal : null, userStreamParam, callbackParam);
            }
            finally
            {
                if (hProcessAddRef)
        ...
        internal static extern unsafe bool MiniDumpWriteDump(HANDLE hProcess, uint processId, HANDLE hFile, MINIDUMP_TYPE dumpType, [Optional] MINIDUMP_EXCEPTION_INFORMATION* exceptionParam, [Optional] IntPtr userStreamParam, [Optional] IntPtr callbackParam);
    }
}
